...
<div class="row">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <h4 class="card-title"> Cycle Amount  Inventory </h4>
      </div>
      <div class="rows" >
    ...
    <br>
        <div class="table-responsive">
          <div class="container-fluid">
            ...
            <tbody>
            <?php
                $a = (int)round($count_rows * 0.1); 
                if ($a == 0) {
                    $a = 1;
                }
                //var_dump($a);
                $b = (int)round($count_rows * 0.3);
                if ($b == 1) {
                    $b = $b+1;
                }
               // var_dump($b);
            ...
            @foreach ($cycle_amount_inventory as $inventory_reports)
              <?php 
                $i++;
              ?>
              <tr>
                ...
                <td>{{ $inventory_reports->average }}</td>
                
                <td>{{ $inventory_reports->totalamount }}</td>
               <td>
