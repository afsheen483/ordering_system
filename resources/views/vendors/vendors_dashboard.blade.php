  ...
  <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
      <div class="dash-widget">
          ...
          <div class="dash-widget-info text-right">
              <h3>98</h3>
              <span class="widget-title1"><a href="next_periority_orders" style="color: rgb(250, 249, 249);">Next Periority Orders </a></span>
          </div>
      </div>
  </div>
  <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
      <div class="dash-widget">
          ...
          <div class="dash-widget-info text-right">
              <h3>1072</h3>
              <span class="widget-title2"><a href="complete_orders" style="color: rgb(250, 249, 249);">Complete Shipped Orders</a></span>
          </div>
      </div>
  </div>
  <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
      <div class="dash-widget">
          ...
          <div class="dash-widget-info text-right">
              <h3>72</h3>
              <span class="widget-title3"><a href="" style="color: rgb(250, 249, 249);">Missing Shippments</a></span>
          </div>
      </div>
  </div>
  <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
